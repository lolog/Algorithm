...
namespace doubly_list{
	...
	template<typename Type>
	void DoublyLinkList<Type>::addHead(Type e)
	{
		m_count++;
	...
	template<typename Type>
	void DoublyLinkList<Type>::addTail(Type e)
	{
		m_count++;
	...
	template<typename Type>
	bool DoublyLinkList<Type>::del(Type e)
	{
		bool is_del = false;
	...
	template<typename Type>
	int DoublyLinkList<Type>::size()
	{
		return m_count;
	}

	template<typename Type>
	bool DoublyLinkList<Type>::contains(Type e)
	{
		if(m_count == 1)
		{
			if(head->m_data == e)
